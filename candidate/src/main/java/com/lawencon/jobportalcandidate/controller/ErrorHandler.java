...
import com.lawencon.jobportalcandidate.dto.ErrorResDto;
import com.lawencon.jobportalcandidate.exception.JobRoad;
...
public class ErrorHandler {
	...
	public ResponseEntity<ErrorResDto<String>> handleHttpClientErrorException(HttpClientErrorException hce) {
		hce.printStackTrace();
		final ErrorResDto<String> resDto = new ErrorResDto<>();
		resDto.setMessage(hce.getMessage());
		return new ResponseEntity<>(resDto,HttpStatus.INTERNAL_SERVER_ERROR);
	}
